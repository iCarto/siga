 ...
 *
 * @since 2.0
 * @source $URL: http://svn.geotools.org/geotools/trunk/gt/modules/library/referencing/src/main/java/org/geotools/referencing/operation/transform/ProjectiveTransform.java $
 * @version $Id: ProjectiveTransform.java 29825 2008-04-07 15:22:58Z desruisseaux $
 ...
 */
public class ProjectiveTransform extends AbstractMathTransform implements  Serializable {
    /**
     ...
     */
    public static MathTransform create(final Matrix matrix) {
     ...
     */
    public static MathTransform create(final AffineTransform matrix) {
        if (matrix.isIdentity()) {
     ...
     * @since 2.3
     */
    public static MathTransform createScale(final int dimension, final double scale) {
        if (scale == 1) {
            return IdentityTransform.create(dimension);
        }
     ...
     * @since 2.3
     */
    public static MathTransform createTranslation(final int dimension, final double offset) {
        if (offset == 0) {
            return IdentityTransform.create(dimension);
        }
        final Matrix matrix = new GeneralMatrix(dimension + 1);
...
//    }
     ...
     * {@link org.geotools.referencefork.referencing.operation.matrix.XMatrix#isIdentity(double)}.
     *
     * @since 2.4
     */
     ...
     * {@value org.geotools.referencefork.parameter.MatrixParameterDescriptors#DEFAULT_MATRIX_SIZE}&times;{@value
     * org.geotools.referencefork.parameter.MatrixParameterDescriptors#DEFAULT_MATRIX_SIZE}.
     * <p>
...
//        static {
//            final NamedIdentifier name = new NamedIdentifier(null/*Citations.OGC*/, "Affine");
...
//                new NamedIdentifier(null/*Citations.EPSG*/, "Affine general parametric transformation"),
//                new NamedIdentifier(null/*Citations.EPSG*/, "9624"),
//                new NamedIdentifier(null/*Citations.GEOTOOLS*/,
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.EPSG*/, "Longitude offset")
//                },
...
//                    new NamedIdentifier(null/*Citations.EPSG*/, "Longitude rotation"),
//                    new NamedIdentifier(null/*Citations.EPSG*/, "9601")
