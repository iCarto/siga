...
import org.geotools.referencefork.referencing.datum.BursaWolfParameters;
 ...
 *
 * @since 2.2
 * @source $URL: http://svn.geotools.org/geotools/trunk/gt/modules/library/referencing/src/main/java/org/geotools/referencing/operation/transform/GeocentricTranslation.java $
 * @version $Id: GeocentricTranslation.java 29852 2008-04-08 20:44:57Z desruisseaux $
...
//    }
    ...
    MathTransform createInverse(final Matrix matrix) {
        return new GeocentricTranslation(matrix);
    }
...
//                        new NamedIdentifier(null/*Citations.GEOTOOLS*/, "src_dim")),
...
//                    Collections.singletonMap(NAME_KEY,
//                        new NamedIdentifier(null/*Citations.GEOTOOLS*/, "tgt_dim")),
//                    DEFAULT_DIMENSION, 2, 3, false);
//
//        /**
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.OGC*/, "src_semi_major")
//                },
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.OGC*/, "src_semi_minor"),
//                },
//                0.0, Double.POSITIVE_INFINITY, SI.METER);
//
//        /**
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.OGC*/, "tgt_semi_major")
//                },
//                0.0, Double.POSITIVE_INFINITY, SI.METER);
//
//        /**
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.OGC*/, "tgt_semi_minor")
//                },
//                0.0, Double.POSITIVE_INFINITY, SI.METER);
//
//        /**
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.OGC*/,  "dx"),
//                    new NamedIdentifier(null/*Citations.EPSG*/, "X-axis translation")
//                },
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.OGC*/,  "dy"),
//                    new NamedIdentifier(null/*Citations.EPSG*/, "Y-axis translation")
//                },
//                0.0, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, SI.METER);
//
//        /**
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.OGC*/,  "dz"),
//                    new NamedIdentifier(null/*Citations.EPSG*/, "Z-axis translation")
//                },
//                0.0, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, SI.METER);
//
//        /**
...
//                new NamedIdentifier(null/*Citations.EPSG*/, "Geocentric translations"),
//                new NamedIdentifier(null/*Citations.EPSG*/, "9603")
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.OGC*/,  "ex"),
//                    new NamedIdentifier(null/*Citations.EPSG*/, "X-axis rotation")
//                },
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.OGC*/,  "ey"),
//                    new NamedIdentifier(null/*Citations.EPSG*/, "Y-axis rotation")
//                },
//                0.0, -MAX_ROTATION, MAX_ROTATION, NonSI.SECOND_ANGLE);
//
//        /**
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.OGC*/,  "ez"),
//                    new NamedIdentifier(null/*Citations.EPSG*/, "Z-axis rotation")
//                },
//                0.0, -MAX_ROTATION, MAX_ROTATION, NonSI.SECOND_ANGLE);
//
//        /**
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.OGC*/,  "ppm"),
//                    new NamedIdentifier(null/*Citations.EPSG*/, "Scale difference")
//                },
...
//                new NamedIdentifier(null/*Citations.EPSG*/, name),
//                new NamedIdentifier(null/*Citations.EPSG*/, code)
//            }, new ParameterDescriptor[] {
