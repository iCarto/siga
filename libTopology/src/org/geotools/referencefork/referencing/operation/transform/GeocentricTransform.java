...
//import org.geotools.referencefork.metadata.iso.citation.Citations;



/**
 * Transforms three dimensional {@linkplain org.geotools.referencefork.referencing.crs.DefaultGeographicCRS
 * geographic} points to {@linkplain org.geotools.referencefork.referencing.crs.DefaultGeocentricCRS geocentric}
 * coordinate points. Input points must be longitudes, latitudes and heights above the ellipsoid.
 *
 * @since 2.0
 * @source $URL: http://svn.geotools.org/geotools/trunk/gt/modules/library/referencing/src/main/java/org/geotools/referencing/operation/transform/GeocentricTransform.java $
 * @version $Id: GeocentricTransform.java 29825 2008-04-07 15:22:58Z desruisseaux $
...
//        int index = 0;
//        if (!hasHeight) {
//            final ParameterValue p = new org.geotools.referencefork.parameter.Parameter(Provider.DIM);
//            p.setValue(2);
//            parameters[index++] = p;
//        }
//        parameters[index++] = new FloatParameter(Provider.SEMI_MAJOR, a);
//        parameters[index++] = new FloatParameter(Provider.SEMI_MINOR, b);
//        return new org.geotools.referencefork.parameter.ParameterGroup(descriptor, parameters);
//    }
...
//        }
     ...
     * from {@linkplain org.geotools.referencefork.referencing.crs.DefaultGeographicCRS geographic} to
     * {@linkplain org.geotools.referencefork.referencing.crs.DefaultGeocentricCRS geocentric} coordinate
     * reference systems.
     *
     * @version $Id: GeocentricTransform.java 29825 2008-04-07 15:22:58Z desruisseaux $
     * @author Martin Desruisseaux
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.OGC*/,  "semi_major"),
//                    new NamedIdentifier(null/*Citations.EPSG*/, "semi-major axis")   //epsg does not specifically define this parameter
//                },
...
//                new NamedIdentifier[] {
//                    new NamedIdentifier(null/*Citations.OGC*/,  "semi_minor"),
//                    new NamedIdentifier(null/*Citations.EPSG*/, "semi-minor axis")   //epsg does not specifically define this parameter
//                },
//                Double.NaN, 0, Double.POSITIVE_INFINITY, SI.METER);
//
//        /**
...
//                        new NamedIdentifier(null/*Citations.GEOTOOLS*/, "dim")),
//                    3, 2, 3, false);
//
//        /**
...
//                    new NamedIdentifier(null/*Citations.OGC*/,      ogc),
//                    new NamedIdentifier(null/*Citations.EPSG*/,     epsgName),
//                    new NamedIdentifier(null/*Citations.EPSG*/,     epsgCode),
//                    new NamedIdentifier(null/*Citations.GEOTOOLS*/, Vocabulary.formatInternational(geotools))
...
//    }
     ...
     * transforms from {@linkplain org.geotools.referencefork.referencing.crs.DefaultGeocentricCRS geocentric}
     * to {@linkplain org.geotools.referencefork.referencing.crs.DefaultGeographicCRS geographic} coordinate
     * reference systems.
     *
     * @version $Id: GeocentricTransform.java 29825 2008-04-07 15:22:58Z desruisseaux $
     * @author Martin Desruisseaux
