...
//    }
                   ...
                   MismatchedReferenceSystemException
    {
        ...
        for (int i=0; i<points.length; i++) {
            ...
            //azabala: added to avoid unnecessary mismatched dimension exceptions
...
//            		System.arraycopy(point.getCoordinates(), 0, newCoordinates, 0, dimension);
//            		point = new GeneralDirectPosition(newCoordinates);
//            	}
//            }
            crs = getCoordinateReferenceSystem(point, crs);
        }
    ...
    class SimpleTransform implements Transformation{
		...
		public SimpleTransform(CoordinateReferenceSystem source,
				CoordinateReferenceSystem target, MathTransform mathTransform) {
			this.source = source;
			this.target = target;
