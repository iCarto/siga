 ...
 *
 * @since 2.0
 * @source $URL: http://svn.geotools.org/geotools/trunk/gt/modules/library/referencing/src/main/java/org/geotools/referencing/operation/builder/LocalizationGridTransform2D.java $
 * @version $Id: LocalizationGridTransform2D.java 29100 2008-02-06 11:46:05Z desruisseaux $
 * @author Remi Eve
                                     ...
                                     implements MathTransform2D, Serializable
{
    ...
    static {
        String property;
        try {
            property = System.getProperty("org.geotools.referencefork.referencing.forceConvergence", "false");
...
//                Logging.getLogger(LocalizationGridTransform2D.class).fine("No convergence");
            ...
            e = new TransformException("Non invertible transform");
            e.initCause(exception);
            throw e;
        }
        throw new TransformException("No convergence");
    }
...
//                new NamedIdentifier(null, "WarpPolynomial")
