 ...
 *
 * @since 2.4
 * @source $URL: http://svn.geotools.org/geotools/trunk/gt/modules/library/referencing/src/main/java/org/geotools/referencing/operation/builder/Polygon.java $
 * @version $Id: Polygon.java 28984 2008-01-28 18:08:29Z acuster $
 * @author Jan Jezek
 */
class Polygon {
     ...
     */
    protected GeneralPathX generateGeneralPath(DirectPosition[] points) {
        GeneralPathX ring = new GeneralPathX();
