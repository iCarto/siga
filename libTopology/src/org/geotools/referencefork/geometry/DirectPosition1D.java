 ...
 *
 * @since 2.0
 * @source $URL: http://svn.geotools.org/geotools/trunk/gt/modules/library/referencing/src/main/java/org/geotools/geometry/DirectPosition1D.java $
 * @version $Id: DirectPosition1D.java 28779 2008-01-16 11:00:24Z desruisseaux $
...
public class DirectPosition1D extends AbstractDirectPosition implements Serializable, Cloneable {
    ...
    public DirectPosition1D clone() {
        DirectPosition1D solution = new DirectPosition1D();
		solution.setLocation(this);
		return solution;
    }
}
