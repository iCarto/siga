 ...
 *
 * @since 2.0
 * @source $URL: http://svn.geotools.org/geotools/trunk/gt/modules/library/referencing/src/main/java/org/geotools/geometry/DirectPosition2D.java $
 * @version $Id: DirectPosition2D.java 28790 2008-01-16 21:17:05Z desruisseaux $
    ...
    public boolean equals(final Object object) {
        ...
        if (object instanceof DirectPosition) {
            ...
            if (other.getDimension() == 2 &&
               ...
               // && other.getCoordinateReferenceSystem().equals(crs)
            ){
            	if(other.getCoordinateReferenceSystem() != null && crs != null){
            		if(!other.getCoordinateReferenceSystem().equals(crs))
            			return false;
            	}
