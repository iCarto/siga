...
package com.vividsolutions.jump.util2;
 ...
 * 
 * FIXME
 * azabala: This class exists in appGvSig project.
 * I think we must move it to libFMap project, to avoid to create
 * dependencies with appGvSig in libraries (by the moment, I copy the 
 * source code)
 * 
 * 
 * 
...
public class CoordinateArrays {
    ...
    public static void addCoordinateArrays(Geometry g, boolean orientPolygons,
        ...
        if (g.getDimension() <= 0) {
            ...
            Assert.shouldNeverReachHere("com.vividsolutions.jump.util.CoordinateArrays.geometry-of-type-{0}-not-handled");
        }
    }
