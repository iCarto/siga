...
public class FilesLinkAction {
    ...
    public void showFiles(long registerIndex) {
        try {
            ...
            int fieldIdx = recordset.getFieldIndexByName(getDirectoryFieldName());
            String registerValue = recordset.getFieldValue(registerIndex, fieldIdx).toString();
            ...
            if (directoryLayerName.equalsIgnoreCase(DBNames.LAYER_REVERSIONES)) {
                ...
                String empresaValue = recordset.getFieldValue(registerIndex, empresaField).toString();
            ...
            } else if (ExpropiationsLayerResolver.isExpropiationLayer(this.data.getLayer())) {
                InfoEmpresa infoEmpresa = ExpropiationsLayerResolver.getInfoEmpresa(this.data.getLayer());

                int tramoField = recordset.getFieldIndexByName(DBNames.FIELD_TRAMO_FINCAS);
                String tramoValue = recordset.getFieldValue(registerIndex, tramoField).toString();
            ...
            String folderPath = baseDirectory + directoryLayerName;
            ...
            if (folder.exists()) {
                ...
                int answer = JOptionPane.showConfirmDialog(null,
                        String.format(PluginServices.getText(this, "folder_not_exists_create_it"), folderName),
                        PluginServices.getText(this, "warning"), JOptionPane.YES_NO_OPTION);
                if (answer == JOptionPane.YES_OPTION) {
                    if (folder.mkdirs()) { // will make *all* directories in the
                        ...
                        JOptionPane.showMessageDialog(null,
                                PluginServices.getText(this, "folder_could_not_be_created") + ": " + folderName);
                    }
                }
            }
