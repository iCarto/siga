...
public class LayoutTest extends TestCase {
    ...
    public void test() {
        ...
        MapSheetsLayoutTemplate mslt = new MapSheetsLayoutTemplate(grid, cloned_pv, auxlayout);
        // mslt.setGrid(msg);
        ...
        mslt.init(new ArrayList(), new ArrayList(), new ArrayList(), 1.5, 1.5, true, null);
    ...
    private static File icon_f = new File(AllTests.TEST_DATA_FOLDER_URL.getAbsolutePath() + File.separator
            + "grid.png");
