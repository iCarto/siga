 ...
 */
public class LayoutAddTextListenerImpl extends LayoutAddRectangleListener {
	 ...
	 * @param l Layout.
	 */
	public LayoutAddTextListenerImpl(Layout l) {
		super(l);
	}
	...
	public void rectangle(RectangleEvent event) throws BehaviorException {
		FFrameText fframe =(FFrameText)FrameFactory.createFrameFromName(FFrameTextFactory.registerName);
		...
		fframe.setFixedFontSize(Boolean.TRUE);
