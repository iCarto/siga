...
public class SenhalesTableModel extends AlphanumericTableModel {
    ...
    public SenhalesTableModel(IEditableSource source, String[] colNames, String[] colAliases, IRowFilter filter) {
        super(source, colNames, colAliases, filter);

        this.alg = new SenhalesAlgorithm(new Dimension(40, 25));
    }

    public SenhalesTableModel(IEditableSource source, String[] colNames, String[] colAliases) {
