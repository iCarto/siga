...
public enum Elements {
    ...
    Enlaces("id_enlace", EnlacesForm.class, null, null, null, "enlaces_imagenes"),
    Firme(
	    "id_firme",
	    FirmeForm.class,
	    BatchAbstractSubForm.class,
    ...
    Ramales("gid", RamalesForm.class, null, null, null, "ramales_imagenes"),
    Competencias("gid", CompetenciasForm.class, null, null, null, null),
    Comunicaciones("gid", ComunicacionesForm.class, null, null, null, "comunicaciones_imagenes");
