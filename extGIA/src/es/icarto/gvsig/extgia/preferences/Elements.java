...
public enum Elements {
    ...
    Barrera_Rigida(
                                            ...
                                            Help.ignoredGidGeom, "codigo", true),
    Barrera_Metalica(
                                            "gid",
    ...
    Centros_Mando("gid", CentrosMandoForm.class, null, null, null, "centros_mando_imagenes", null, Help.ignoreGeom, null, true),
    Competencias("gid", CompetenciasForm.class, null, null, null, null, null, Help.ignoreGeom, null, true),
    Comunicaciones("gid", ComunicacionesForm.class, null, null, null, "comunicaciones_imagenes", null, Help.ignoreGeom, null, false),
    ...
    Enlaces(
                                                    ...
                                                    Help.ignoredGidGeom, "nombre", true),
    Fibra_Optica_Derivaciones("gid", FibraOpticaDerivacionesForm.class, null, null, null, "fibra_optica_derivaciones_imagenes", null, Help.ignoreGeom, null, false),
    Firme(
                                                            "id_firme",
                                                            FirmeForm.class,
                                                            BatchAbstractSubForm.class,
                                                            ...
                                                            Help.ignoredGidGeom, "unidad_constructiva", false),
    Isletas(
                                                                    "id_isleta",
                                                                    IsletasForm.class,
    ...
    Lineas_Suministro(
                                                                                            ...
                                                                                            Help.ignoredGidGeom, "denominacion", true),
    Muros(
                                                                                                    "id_muro",
                                                                                                    MurosForm.class,
                                                                                                    BatchAbstractSubForm.class,
    ...
    public String getStylizedName() {
        ...
        return (NAMES.containsKey(this.name())) ? NAMES.get(this.name()) : this
                .name();
    }
}