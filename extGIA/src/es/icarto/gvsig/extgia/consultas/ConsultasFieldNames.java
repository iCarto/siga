...
public class ConsultasFieldNames {
    ...
    public static String taludesCSVFieldNames() {
        return "gid, " + "el.id_talud as \"ID Talud\"," + "numero_talud as \"Nº Talud\","
                + "fecha_actualizacion as \"Fecha Actualización\","
                + localizationCSVFieldNames()
    ...
    public static String isletasCSVFieldNames() {
        return "gid, " + "el.id_isleta as \"ID Isleta\"," + "numero_isleta as \"Nº Isleta\","
                + "fecha_actualizacion as \"Fecha Actualización\"," + localizationCSVFieldNames()
                + "pk_inicial as \"PK Inicial\"," + "pk_final as \"PK Final\"," + "ramal as \"Ramal\","
                + "st.item as \"Sentido\"," + "direccion as \"Dirección\"," + "margen as \"Margen\","
    ...
    public static String barreraRigidaCSVFieldNames() {
        return "gid, " + "el.id_barrera_rigida as \"ID Barrera Rígida\","
                ...
                + "pk_inicial as \"PK Inicial\"," + "pk_final as \"PK Final\"," + "ramal as \"Ramal\","
                + "st.item as \"Sentido\"," + "direccion as \"Dirección\"," + "margen as \"Margen\","
                + "mu.item as \"Municipio\"," + "obstaculo_protegido as \"Obstáculo Protegido\","
                + "longitud as \"Longitud\"," + "codigo as \"Código\"," + "tipo as \"Tipo\","
                + "metodo_constructivo as \"Método Constructivo\"," + "perfil as \"Perfil\","
                + "observaciones as \"Observaciones\"";
    }

    public static String areasServicioCSVFieldNames() {
        return "gid, " + "el.id_area_servicio as \"ID Área Servicio\"," + "nombre as \"Nombre\","
                ...
                + "cafeteria_rest_bar as \"Cafetería\"," + "aparcamiento_camion_bus as \"Aparcamientos\","
                + "area_picnic as \"Área Picnic\"," + "fuentes_potables as \"Fuentes Potables\","
                + "observaciones as \"Observaciones\"";
        // + getFieldCountRamales("areas_servicio");
    }

    public static String areasDescansoCSVFieldNames() {
        return "gid, " + "el.id_area_descanso as \"ID Área Descanso\"," + "nombre as \"Nombre\","
                + "fecha_actualizacion as \"Fecha Actualización\"," + localizationCSVFieldNames() + "pk as \"PK\","
                + "st.item as \"Sentido\"," + "mu.item as \"Municipio\","
                + "fecha_puesta_servicio as \"Fecha Puesta Servicio\"," + "sup_total as \"Superficie Total\","
                + "sup_pavimentada as \"Superficie Pavimentada\"," + "aceras as \"Aceras\","
                + "bordillos as \"Bordillos\"," + "zona_siega as \"Zona Siega\","
                + "zona_ajardinada as \"Zona Ajardinada\"," + "riego as \"Riego\","
                + "aparcamiento_camion_bus as \"Aparcamientos\"," + "area_picnic as \"Área Picnic\","
    ...
    public static String areasPeajeCSVFieldNames() {
        return "gid, " + "el.id_area_peaje as \"ID Área Peaje\"," + "nombre as \"Nombre\","
                + "fecha_actualizacion as \"Fecha Actualización\"," + localizationCSVFieldNames() + "pk as \"PK\","
                + "st.item as \"Sentido\"," + "mu.item as \"Municipio\","
                + "fecha_puesta_servicio as \"Fecha Puesta Servicio\"," + "n_salida as \"Número de salida\","
                + "bordillos as \"Longitud bordillos(m)\"," + "bumpers as \"Bumpers(nº)\","
                + "tunel_peaje as \"Túnel de peaje\"," + "long_tunel as \"Longitud Túnel\","
                + "marquesina_tipo as \"Tipo\"," + "marquesina_sup as \"Superficie (m2)\","
                + "sup_total as \"Superficie total(m2)\"," + "sup_trieff as \"Sup. adoquín trieff(m2)\","
                + "sup_hormigon as \"Sup. adoquín hormigón(m2)\"," + "sup_otros as \"Sup. otros(m2)\","
                + "numero_vias as \"Número vías\"," + "observaciones as \"Observaciones\"";
    }

    public static String pasosMedianaCSVFieldNames() {
        return "gid, " + "el.id_paso_mediana as \"ID Paso Mediana\","
                + "fecha_actualizacion as \"Fecha Actualización\"," + localizationCSVFieldNames() + "pk as \"PK\","
                + "mu.item as \"Municipio\"," + "longitud as \"Longitud\"," + "numero_postes as \"Nº Postes\","
    ...
    public static String juntasCSVFieldNames() {
        return "gid, " + "el.id_junta as \"ID Junta\"," + "fecha_actualizacion as \"Fecha Actualización\","
                + localizationCSVFieldNames() + "pk as \"PK\"," + "ramal as \"Ramal\"," + "st.item as \"Sentido\","
                + "direccion as \"Dirección\"," + "mu.item as \"Municipio\"," + "numero_junta as \"Nº Junta\","
                + "ancho as \"Ancho\"," + "modulo as \"Módulo\"," + "elemento as \"Elemento\","
                + "codigo_elemento as \"Código Elemento\"," + "descripcion as \"Descripción\","
                + "observaciones as \"Observaciones\"";
    }

    public static String enlacesCSVFieldNames() {
        return "gid, " + "el.id_enlace as \"ID Enlace\"," + "nombre as \"Nombre\","
                + "fecha_actualizacion as \"Fecha Actualización\"," + localizationCSVFieldNames() + "el.pk as \"PK\","
                + "mu.item as \"Municipio\"," + "n_salida as \"Nº Salida\","
    ...
    public static String vallaCierreCSVFieldNames() {
        return "gid, " + "el.id_valla as \"ID Valla\"," + "fecha_actualizacion as \"Fecha Actualización\","
                ...
                + "pastor_electrico as \"Pastor Eléctrico\"," + "observaciones as \"Observaciones\"";
    }

    public static String firmeCSVFieldNames() {
        return "gid, " + "el.id_firme as \"ID Firme\"," + "fecha_inauguracion as \"Fecha Inauguración\","
                ...
                + "gc_arido_fino as \"Grava-Cemento: Árido Fino\"," + "gc_cemento as \"Grava-Cemento: Cemento\","
                + "mbc_bas_huso as \"MBC Base: Huso (cm)\","
                + "mbc_bas_arido_grueso as \"MBC Base: Árido Grueso (cm)\","
                + "mbc_bas_arido_fino \"MBC Base: Árido Fino (cm)\"," + "mbc_bas_filler as \"MBC Base: Filler\","
    ...
    public static String murosCSVFieldNames() {
        return "gid, " + "el.id_muro as \"ID Muro\"," + "fecha_actualizacion as \"Fecha Actualización\","
                + localizationCSVFieldNames() + "tvf.item as \"Tipo Vía PF\"," + "nvf.item as \"Nombre Vía PF\","
                + "pk_inicial as \"PK Inicial\"," + "pk_final as \"PK Final\"," + "ramal_pi as \"Ramal\","
                + "ramal_pf as \"Ramal PF\"," + "direccion_pi as \"Dirección\"," + "direccion_pf as \"Dirección PF\","
                + "st.item as \"Sentido\"," + "margen as \"Margen\"," + "mu.item as \"Municipio\","
                + "material as \"Material\"," + "longitud as \"Longitud\"," + "altura_max as \"Altura Máxima\","
                + "observaciones as \"Observaciones\"";
    }
    ...
    public static String lechoFrenadoCSVFieldNames() {
        return "gid, " + "el.id_lecho_frenado as \"ID Lecho Frenado\","
                ...
                + "anchura as \"Anchura(m)\"," + "pendiente as \"Pendiente máxima(%)\","
                + "observaciones as \"Observaciones\"";
    }

    public static String areasMantenimientoCSVFieldNames() {
        return "gid, " + "el.id_area_mantenimiento as \"ID Área Mantenimiento\"," + "nombre as \"Nombre\","
                + "fecha_actualizacion as \"Fecha Actualización\"," + localizationCSVFieldNames() + "pk as \"PK\","
                + "st.item as \"Sentido\"," + "mu.item as \"Municipio\","
                ...
                + "control_tuneles as \"Control de túneles\"," + "almacen_fundentes as \"Almacén de fundentes\","
    ...
    public static String senhalizacionVariableCSVFieldNames() {
        return "gid, " + "el.id_senhal_variable as \"ID Señal\"," + "fecha_actualizacion as \"Fecha Actualización\","
                + localizationCSVFieldNames() + "pk as \"PK\"," + "ramal as \"Ramal\"," + "st.item as \"Sentido\","
                + "direccion as \"Dirección\"," + "margen_senhal as \"Margen Señal\"," + "mu.item as \"Municipio\","
                + "referencia as \"Nº Referencia\"," + "fecha_instalacion as \"Fecha Instalación\","
                + "tipo as \"Tipo\"," + "tipo_sustentacion as \"Tipo Sustentación\"," + "corunha as \"A Coruña\","
    ...
    public static String lineasSuministroCSVFieldNames() {
        return "gid, " + "el.id_linea_suministro as \"ID Línea\"," + "fecha_actualizacion as \"Fecha Actualización\","
                + localizationCSVFieldNames() + "tvf.item as \"Tipo Vía PF\"," + "nvf.item as \"Nombre Vía PF\","
                + "pk_inicial as \"PK Inicial\"," + "pk_final as \"PK Final\"," + "ramal_pi as \"Ramal\","
                + "ramal_pf as \"Ramal PF\"," + "direccion_pi as \"Dirección\"," + "direccion_pf as \"Dirección PF\","
                + "st.item as \"Sentido\"," + "margen as \"Margen\"," + "mu.item as \"Municipio\","
                + "denominacion as \"Denominación\"," + "titularidad as \"Titularidad\"," + "estado as \"Estado\","
                + "tipo as \"Tipo\"," + "longitud as \"Longitud(m)\"," + "num_apoyos as \"Nº Apoyos\","
                + "observaciones as \"Observaciones\"";
    }

    public static String ramalesCSVFieldNames() {
        return "gid, fecha_actualizacion as \"Fecha Actualización\"," + localizationCSVFieldNames() + "pk as \"PK\","
                + "ramal as \"Ramal\"," + "st.item as \"Sentido\"," + "direccion as \"Dirección\","
    ...
    public static String comunicacionesCSVFieldNames() {
        return "gid as \"ID Comunicación\", fecha_actualizacion as \"Fecha Actualización\","
                ...
                + "seccion as \"Seccion\"," + "longitud as \"Longitud\"," + "n_elementos as \"Número de elementos\","
                + "descripcion as \"Descripción\"," + "observaciones as \"Observaciones\"";
    }

    public static String tunelesCSVFieldNames() {
        return "gid as \"ID Túnel\"," + "nombre as \"Nombre\"," + "fecha_actualizacion as \"Fecha Actualización\","
    ...
    public static String drenCazCSVFieldNames() {
        return "gid as \"ID Dren-Caz\"," + localizationCSVFieldNames() + "pk as \"PK\"," + "ramal as \"Ramal\","
                + "st.item as \"Sentido\"," + "direccion as \"Dirección\"," + "mu.item as \"Municipio\","
    ...
    public static String cunetasCSVFieldNames() {
        return "gid as \"ID Cuneta\"," + localizationCSVFieldNames() + "pk_inicial as \"PK Inicial\","
                ...
                + "margen as \"Margen\"," + "direccion as \"Dirección\"," + "mu.item as \"Municipio\","
    ...
    public static String lineasDistribucionUFDCSVFieldNames() {
        return "gid as \"ID Línea distribucion UFD\", tr.item as \"Tramo\", pk as \"PK (Km)\", "
        		+ "denominacion as \"Denominación\", matricula as \"Matrícula\", linea as \"Línea\", tipo as \"Tipo\", tension as \"Tensión\", longitud as \"Longitud (m)\"";
    }

    public static String fibraOpticaDerivacionesCSVFieldNames() {
        return "gid as \"ID Fibra óptica derivaciones\", tr.item as \"Tramo\", pk as \"PK (Km)\", expediente as \"Número de expediente\", companhia as \"Compañía\", observaciones as \"Observaciones\"";
