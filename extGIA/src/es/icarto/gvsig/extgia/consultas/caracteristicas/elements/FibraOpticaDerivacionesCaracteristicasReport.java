...
public class FibraOpticaDerivacionesCaracteristicasReport extends PDFCaracteristicasReport {

	public FibraOpticaDerivacionesCaracteristicasReport(String[] element,
	...
	protected String[] getColumnNames() {
		String[] columnNames = { "ID Fibra óptica derivaciones", "Tramo", "PK", "Expediente", "Compañía", "Observaciones" };
			return columnNames;
	}
