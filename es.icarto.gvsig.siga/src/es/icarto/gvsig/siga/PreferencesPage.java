...
public class PreferencesPage extends AbstractPreferencePage {
    ...
    static {
        SIGA_LOGO = new File("gvSIG/extensiones/es.icarto.gvsig.siga/images/logo_siga.png").getAbsolutePath();
        SIGA_REPORT_LOGO = new File("gvSIG/extensiones/es.icarto.gvsig.siga/images/logo_siga_report.png")
                .getAbsolutePath();
        LOGO_PATH = new File("gvSIG/extensiones/es.icarto.gvsig.siga/images/").getAbsolutePath() + "/";
        AUDASA_REPORT_LOGO = new File("gvSIG/extensiones/es.icarto.gvsig.siga/images/logo_audasa_report.png")
                .getAbsolutePath();
        AUTOESTRADAS_REPORT_LOGO = new File(
                "gvSIG/extensiones/es.icarto.gvsig.siga/images/logo_autoestradas_report.png").getAbsolutePath();
    }
    ...
    public static final String AUTOESTRADAS_REPORT_LOGO;
    ...
    private void initPanel() {
        ...
        agExpropiationsFolder = new FolderChooser(panel, PluginServices.getText(this, "AG Expropiaciones"), "");

        agInventoryFolder = new FolderChooser(panel, PluginServices.getText(this, "AG Inventario"), "");

        apExpropiationsFolder = new FolderChooser(panel, PluginServices.getText(this, "AP Expropiaciones"), "");

        apInventoryFolder = new FolderChooser(panel, PluginServices.getText(this, "AP Inventario"), "");
