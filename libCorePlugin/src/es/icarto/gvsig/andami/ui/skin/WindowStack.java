...
public class WindowStack {
    ...
    private final boolean[] key_free;
    private final String[] key;

    private final Vector<IWindow> vistas = new Vector<IWindow>();

    private final Hashtable<IWindow, Menu> viewMenu = new Hashtable<IWindow, Menu>();
    private final WindowSupport ws;

    /**
     * @param vis
     */
    public WindowStack(WindowSupport ws) {
        this.ws = ws;
    ...
    public void add(IWindow v, final ActionListener listener) {
        WindowInfo vi = ws.getWindowInfo(v);
        int id = vi.getId();
        Menu m = new Menu();
