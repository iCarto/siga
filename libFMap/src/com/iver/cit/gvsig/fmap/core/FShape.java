 ...
 * 
 * If a new base type is defined it should have a code under 512 to allow it to be combined with Z o M
 */
public interface FShape extends Shape, Serializable {
    ...
    /**
     * <p>A set that can contain points, lines and polygons. This is usual in <i>CAD</i> layers <i>(dxf, dgn,
     * dwg)</i>.</p>
     */
     ...
     * 
     * @param at
     *            object that allows execute the affine transformation
     * 
     * @see AffineTransform
     */
